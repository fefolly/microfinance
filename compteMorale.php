<?php
    ...
    {
	header('Location:personneMorale.php');
        exit();
    }
...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="span10">
                <form class="form-horizontal" action="compteMorale.php" method="post" enctype="multipart/form-data">
		    <div class="row">
			<div class="span5">
			    <?php
			...
			<div class="span5">
			    <div class="control-group">
			       ...
			       <div class="controls">
				  <input type="text" name="raison" placeholder="" value="<?php echo $_SESSION['raison']; ?>" readOnly>
			       </div>
			    </div>
			</div>
			<div class="span5">
			    <div class="control-group">
			       ...
			       <div class="controls">
				  <input type="text" name="sigle" placeholder="" value="<?php echo $_SESSION['sigle']; ?>" readOnly>
			       </div>
			    </div>
			</div>
		    </div>
