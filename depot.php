<?php
    ...
    if(isset($_POST['enregistrer']) && $_POST['enregistrer'] == 'Enregistrer')
    {
	    ...
	    $_SESSION['login'] = $_POST['login'];
            ...
            if ($reponse1 == 1)
            {
	        $iden = $db->query('SELECT * FROM depot ORDER BY idDepot DESC LIMIT 1 ')->fetchColumn();
		...
		//Tout ceci peut etre mis en fonction
		    ...
		    $str = "INSERT INTO depot VALUES ( '$iden', '".mysql_escape_string($_POST['login'])."', '".mysql_escape_string($_POST['num'])."', NOW(),
                            '".mysql_escape_string($_POST['montant'])."', '".mysql_escape_string($_POST['commentaire'])."', '".mysql_escape_string($_POST['indication'])."' )";
...
<div class="container">
		...
		<form class="form-horizontal" action="depot.php" method="post" >
			...
			<div class="span5">
			    <div class="control-group">
				<label class="control-label" for="">Date d&eacute;pot</label>
				<div class="controls">
			...
			<div class="span5">
			    <div class="control-group">
				<label class="control-label" for="">Montant d&eacute;pot</label>
				<div class="controls">
